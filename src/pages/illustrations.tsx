    ...
    <Paper elevation={3} sx={{ p: 2, my: 2, mx: 'auto', maxWidth: 'md' }}>
      <Container maxWidth="md">
        ...
        <Typography variant="body1" paragraph>
          ...
          graduate of the Center for Cartoon Studies masters program class of 2020. Since then, she
          has been teaching Sequential Art at Champlain College since 2021. Her comics are also
          featured bi-monthly in the state-wide free newspaper, Seven Days.
        </Typography>
        ...
        <Typography variant="body1" paragraph>
          Her self-published works include Ego Gala, a four-paneled diary comic kept daily for three
          years that have been compiled into three books (2019, 2020, and 2021).
        </Typography>
