    ...
    <ThemeProvider theme={theme}>
      ...
      <Paper elevation={3} sx={{ p: 2, my: 2, mx: 'auto', maxWidth: 'md' }}>
        <Container maxWidth="md">
          ...
          <Typography variant="body1" paragraph>
            Her self-published works include Ego Gala, a four-paneled diary
            comic kept daily for three years that have been compiled into three
            books (2019, 2020, and 2021).
          </Typography>
          ...
          <Typography variant="body1" paragraph>
            Kristen is also the co-editor of Fantology with friend and fellow
            CCS alum, Emily Zea.
          </Typography>
          <Typography variant="body1" paragraph>
